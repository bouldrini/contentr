class Contentr::SiteTabulatrData < Tabulatr::Data
  search :name
  ...
  #   link_to "<div class='btn btn-danger'><i class='icon icon-trash'></i></div>".html_safe, "", method: :delete, id: rec.id, data: {delete: true, name: "der Tarif '#{rec.title}'"}
  # end
  column :name
end
